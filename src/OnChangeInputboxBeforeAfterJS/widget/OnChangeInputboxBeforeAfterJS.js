define([
    ...
    return declare("OnChangeInputboxBeforeAfterJS.widget.OnChangeInputboxBeforeAfterJS", [_WidgetBase, _TemplatedMixin], {
        ...
        onChangeMicroflow: function() {
            // run before JS snippet (catch exceptions)
            try {
                eval(this.beforeJS);
            } catch(e) {
            }
            ...
            this.executeMicroflow(this.onchangemf, a);
        },
        ...
        executeMicroflow: function(mf, c) {
            var callback = function() {};
            if (typeof c === 'function') {
                callback = dojoLang.hitch(this, c);   
            }
            if (mf && this.obj) {
                mx.data.action({
                    store: {
